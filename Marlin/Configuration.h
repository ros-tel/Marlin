 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 10000, 10000 }
...
#define X_BED_SIZE 399
#define Y_BED_SIZE 499
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS           3 // Initial brightness (0-255)
